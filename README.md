## Olá
Atualmente estou em uma jornada intensa de transição e especialização em Engenharia de Software. Com uma base prévia em Web Design e experiência no setor de varejo, estou unindo a visão de produto com a robustez do Python e SQL.

🔭 Projeto Atual: Desenvolvendo um sistema de gestão para a Rei Agro (Pet Shop) como projeto acadêmico.
...
🔭 Current Project: Developing a management system for Rei Agro (Pet Shop) as a university project.
